...
const srcDir = path.join(root, "images", "services-images");
const optDir = path.join(root, "images", "opt");
const photoDir = path.join(root, "images", "photo");

const MAP = [
  ["custom-software.jfif", "svc-software"],
  ["web-dev.jfif", "svc-web"],
  ["web-develop.jfif", "svc-webapps"],
  ["mobile-app.jfif", "svc-mobile"],
  ["cloud-engineering.jfif", "svc-cloud"],
  ["UIUX.jfif", "svc-uiux"],
  ["Ai-automation.jfif", "svc-ai"],
  ["social-media.jfif", "svc-social"],
  ["It-con.jfif", "svc-consulting"],
  ["DevOps.jfif", "svc-devops"],
  ["Data-engineer.jfif", "svc-dataeng"],
  ["Data-analysis.jfif", "svc-analytics"],
  ["Api-development.jfif", "svc-api"],
  ["Business-automation.jfif", "svc-bizauto"],
];

const PAGES = [
  ["software-development.html", "svc-software"],
  ["web-development.html", "svc-web"],
  ["web-applications.html", "svc-webapps"],
  ["mobile-apps.html", "svc-mobile"],
  ["cloud-engineering.html", "svc-cloud"],
  ["ui-ux-design.html", "svc-uiux"],
  ["ai-automation.html", "svc-ai"],
  ["social-media.html", "svc-social"],
  ["it-consulting.html", "svc-consulting"],
  ["devops.html", "svc-devops"],
  ["data-engineering.html", "svc-dataeng"],
  ["data-analytics.html", "svc-analytics"],
  ["api-integration.html", "svc-api"],
  ["business-automation.html", "svc-bizauto"],
];
...
function patchPage(file, stem) {
  ...
  html = html.replace(/href="\/css\/components\.css[^"]*"/, 'href="/css/components.css?v=svc1"');
  html = html.replace(/href="\/css\/responsive\.css[^"]*"/, 'href="/css/responsive.css?v=svc1"');
  const re =
